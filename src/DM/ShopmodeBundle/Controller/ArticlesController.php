...
class ArticlesController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $articles = $em->getRepository('DMShopmodeBundle:Articles')->findAll();
    ...
    {
        $article = new Article();
        $form = $this->createForm('DM\ShopmodeBundle\Form\ArticlesType', $article);
    ...
    {
        $deleteForm = $this->createDeleteForm($article);
        $editForm = $this->createForm('DM\ShopmodeBundle\Form\ArticlesType', $article);
